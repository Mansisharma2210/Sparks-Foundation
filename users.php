...
<body>
    <!-- Nav bar -->
    <nav class="navbar py-2 navbar-expand-lg navbar-dark bg-danger">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">LOCAL BANK</a>
    ...
    <div class="d-grip gap-2 col-6 mx-auto text-center p-3 mb-2">
        ...
        <a href="history.php"><button type="button" class="btn btn-success btn-lg mb-3">Transaction History</button></a>
    </div>
    </div>
 ...
 <div class="container">
        ...
        <label style="color : black;"><strong>Send To:</strong></label>
        ...
        <br>
            ...
            <br><br>
                ...
                <button class="btn btn-outline-success mb-3" name="submit" type="submit" id="myBtn" >Fill the Amount and Transfer</button>
            </div>
        </form>
    </div>    
